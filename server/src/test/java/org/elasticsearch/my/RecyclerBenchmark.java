...
/**
 * https://github.com/elastic/elasticsearch/commit/e01f8c250d9c79911180b2e383fb184f4d278222
 *
 * @author bairen
 * @description
 **/
public class RecyclerBenchmark {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        final ImmutableMap<String, Recycler<Object>> recyclers = ImmutableMap.<String, Recycler<Object>>builder()
            .put("none", Recyclers.none(c))
            .put("concurrent-queue", Recyclers.concurrentDeque(c, limit))
            .put("locked", Recyclers.locked(Recyclers.deque(c, limit)))
            .put("concurrent", Recyclers.concurrent(Recyclers.dequeFactory(c, limit), Runtime.getRuntime().availableProcessors())).build();
