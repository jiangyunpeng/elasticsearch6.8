...
public class Netty4Transport extends TcpTransport {
    ...
    protected class ClientChannelInitializer extends ChannelInitializer<Channel> {
        ...
        protected void initChannel(Channel ch) throws Exception {
            ...
            ch.pipeline().addLast("dispatcher", new Netty4MessageChannelHandler(pageCacheRecycler, Netty4Transport.this,"client"));
        }
    ...
    protected class ServerChannelInitializer extends ChannelInitializer<Channel> {
        ...
        protected void initChannel(Channel ch) throws Exception {
            ...
            ch.pipeline().addLast("logging", new ESLoggingHandler());
            ch.pipeline().addLast("dispatcher", new Netty4MessageChannelHandler(pageCacheRecycler, Netty4Transport.this,"server"));
